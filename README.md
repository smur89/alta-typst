...
```typst
#import "@preview/altacv:1.4.2": alta
```
...
<!-- x-release-please-start-version -->
```typst
#import "@preview/altacv:1.4.2": alta, maps-providers, palettes
...
<!-- x-release-please-start-version -->
```typst
#import "@preview/altacv:1.4.2": alta, tag, divider, palettes, maps-providers
```
<!-- x-release-please-end -->
